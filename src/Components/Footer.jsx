        ...
        <div className="lg:w-3/5">
          <div className="flex flex-col gap-8 justify-center pb-12 border-b-2 border-neutral lg:flex-row ">
            <div className="w-full mt-8 lg:mt-0">
              <h3 className="font-bold  text-xl pb-4" style={{ color: "#363636" }}>
                HOME
              </h3>
          ...
          <div className="justify-between items-end pt-12 lg:flex">
            <div>
              <h3 className="font-bold text-neutral text-2xl pb-4">Follow Us</h3>
              <span className="flex items-center justify-center gap-4 lg:py-0 py-4">
                <button className="w-10 h-10 flex justify-center items-center rounded-full text-white bg-neutral hover:bg-primary hover:text-neutral" aria-label="Instagram">
                  <FaInstagram />
                </button>
                <button className="w-10 h-10 flex justify-center items-center rounded-full text-white bg-neutral hover:bg-primary hover:text-neutral" aria-label="Facebook">
                  <FaFacebookF />
                </button>
                <button className="w-10 h-10 flex justify-center items-center rounded-full text-white bg-neutral hover:bg-primary hover:text-neutral" aria-label="Twitter">
                  <FaXTwitter />
                </button>
                <button className="w-10 h-10 flex justify-center items-center rounded-full text-white bg-neutral hover:bg-primary hover:text-neutral" aria-label="Youtube">
                  <FaYoutube />
                </button>
              </span>
            </div>
