        ...
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="lg:flex items-center justify-center gap-12 py-12">
            <div className="lg:w-1/3 rounded-md relative overflow-hidden">
              <img src="./coach.jpg" alt="" className="w-full h-[30rem] rounded-md hoverImg" />
            </div>
            <div className="lg:w-1/3">
              ...
              <div className="flex items-center">
                {[...Array(3)].map((_, index) => (
                  <img key={index} src="./coach.jpg" alt="" className="w-10 h-10 -mr-4 rounded-full border border-white" />
                ))}
